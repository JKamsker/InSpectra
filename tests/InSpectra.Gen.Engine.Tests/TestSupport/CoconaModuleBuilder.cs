...
using InSpectra.Gen.Engine.Modes.Static.Attributes.Cocona;
...
internal sealed class CoconaModuleBuilder : IDisposable
{
    ...
    public IReadOnlyDictionary<string, InSpectra.Gen.Engine.Modes.Static.Metadata.StaticCommandDefinition> ReadCommands()
    {
