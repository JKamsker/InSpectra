namespace InSpectra.Lib.Modes.Static.FrameworkDetection;

using System.Runtime.CompilerServices;

using InSpectra.Lib.Modes.Static.Attributes;
using InSpectra.Lib.Modes.Static.Attributes.Cocona;
using InSpectra.Lib.Modes.Static.Attributes.SystemCommandLine;
